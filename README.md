...
Плагин предназначен для WordPress-проектов. Если хочешь, я добавлю отдельный `LICENSE` файл с GPLv2-or-later для полной совместимости с экосистемой WordPress.
